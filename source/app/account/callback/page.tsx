...
import {EXPERIENCE_VERSION} from '@/lib/experience';
export default function Callback(){
 ...
 useEffect(()=>{let active=true;async function complete(){
  try{
   ...
   const raw=sessionStorage.getItem('nowgo-pending-consent')||sessionStorage.getItem('hot-pending-consent');
   ...
   await api('/api/customer/consents',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({essential:true,marketingEmail:!!pending.marketingEmail,version:EXPERIENCE_VERSION})});
   sessionStorage.removeItem('nowgo-pending-consent');
