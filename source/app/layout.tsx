...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "https://sweet.nowgo.space/og/share-sweet-02-20260926-v2.jpg", width: 1200, height: 630, alt: "SWEET | 맛잘알의 디저트 지도 공유 이미지" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "SWEET | 맛잘알의 디저트 지도",
    description: "케이크와 달콤한 메뉴를 취향대로 찾아보세요.",
    images: ["https://sweet.nowgo.space/og/share-sweet-02-20260926-v2.jpg"],
  },
