...
export async function POST(req:Request,{params}:Ctx){
 ...
 try{
  ...
  if(role==='customer'&&storeId){
   ...
   customerStore=data;shop=data.name;address=data.address;
  }
