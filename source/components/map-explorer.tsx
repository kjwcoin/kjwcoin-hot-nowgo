 ...
 return <main className="explorer">
  <header className="explorer-toolbar">
   ...
   <div className="explorer-filters" aria-label="메뉴 검색 조건">
    ...
    <label>리치 메뉴 메뉴<NativeSelect aria-label="리치 메뉴 메뉴" value={category} onChange={e=>setCategory(e.target.value)}>{CATEGORIES.map(c=><option key={c} value={c}>{c==='전체'?'모든 메뉴':c}</option>)}</NativeSelect></label>
