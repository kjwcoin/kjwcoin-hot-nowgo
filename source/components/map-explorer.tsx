 ...
 return <main className="explorer">
  ...
  <div className="explorer-surface">
   ...
   <aside className={`explorer-results ${expanded?'expanded':'collapsed'}`} aria-label="검색된 메뉴">
    ...
    {expanded&&<div id="map-results" className="explorer-results-body"><p className="explorer-example">{userLocation?'예시 가매장은 주소가 확인된 위치에만 표시 · 실제 영업하지 않아요':'내 위치 버튼을 누르면 15km 안의 메뉴를 보여드려요'}</p>
