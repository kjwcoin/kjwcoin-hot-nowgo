...
export default function CustomerPanel({experience='hot'}:{experience?:ExperienceKey}){
 const name=EXPERIENCES[experience].name;
 ...
 useEffect(()=>{void Promise.resolve().then(refresh);const changed=()=>void refresh();window.addEventListener('hot-customer-change',changed);return()=>window.removeEventListener('hot-customer-change',changed)},[]);
