...
{isDemo:true,id:'demo-menu-01',placeId:'demo-place-01',name:'말차 크림 케이크',shop:'성수 민트카페 · 가매장',price:8900,heat:3,flavor:'크리미한',category:'케이크',image:card('MATCHA CAKE','cream · tea · soft','#cfeee3'),lat:37.5446,lng:127.0557,area:'서울 성동구 · 성수동',description:'쌉싸름한 말차와 부드러운 크림. 커피와 천천히 즐기고 싶은 한 조각.'},
{isDemo:true,id:'demo-menu-02',placeId:'demo-place-02',name:'솔티드 버터 크루아상',shop:'해운대 베이크샵 · 가매장',price:5200,heat:2,flavor:'버터리한',category:'베이커리',image:card('BUTTER CROISSANT','salty · flaky · warm','#e8f5d8'),lat:35.1631,lng:129.1635,area:'부산 해운대구 · 해운대',description:'겹겹이 바삭한 결에 버터 향이 은은하게 남는 디저트. 가볍게 달콤한 날의 선택.'},
{isDemo:true,id:'demo-menu-03',placeId:'demo-place-03',name:'제주 우유 젤라또',shop:'애월 스윗바 · 가매장',price:6500,heat:4,flavor:'고소한',category:'아이스크림·빙수',image:card('MILK GELATO','milk · cool · smooth','#d7f3ec'),lat:33.4627,lng:126.3094,area:'제주 제주시 · 애월',description:'우유의 고소함과 매끈한 단맛. 산책하다 차갑게 한 스푼 당기는 날.'}
];
